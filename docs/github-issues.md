...
| 2 | [推送] 在真实推送通道验证文本渲染与通道无关护栏 | area: push | §9.4 | ✅ 代码已加 `sanitizeNotifyText` + 真实来源标签；运行期真通道验证待部署后 |
...
| 7 | [测试] 补充集成与安全测试 | area: testing | §13 | ✅ 已落地 37 例 Miniflare+D1 集成测试（tests/integration）+ 56 例单测，全量 93 例 / 15 文件通过 |
